...
local lang = {
  common = {
    welcome = "Bine ai venit pe Realism Romania!",
    no_player_near = "~w~Niciun jucator in jurul tau",
    invalid_value = "~w~Valoare invalida",
    invalid_name = "~w~Numar invalid",
    not_found = "~w~Nu a fost gasit",
    request_refused = "~w~Cerere refuzata",
    wearing_uniform = "~w~Ai grija, porti o uniforma",
    not_allowed = "~w~Nu este permis"
  },
  weapon = {
    pistol = "Pistol"
  },
  ...
  money = {
    display = "<span class=\"symbol\"></span><i class='far fa-money-bill-alt' ></i> {1}",
    bdisplay = "<span class=\"symbol\"></span><i class='far fa-credit-card' ></i> {1}",
    onlinePlayers = "<span class=\"symbol\">Online:</span> {1}",
    GiftPoints = "<span class=\"symbol\">IceCoins</span> {1}",
    donationCoins = "<span class=\"symbol\"></span><i class='far fa-gem' ></i> {1}",
    given = "Ai dat ~r~{1} ~w~(de) €.",
    received = "~w~Ai primit ~b~{1} ~w~(de) €.",
    not_enough = "~w~Nu ai suficienti bani",
    paid = "~w~Ai platit ~r~{1} ~w~(de) €.",
    give = {
      title = "Ofera Bani",
  ...
  coins = {
    ...
    onlinePlayers = "<span class=\"symbol\">Online:</span> {1}",
    GiftPoints = "<span class=\"symbol\">IceCoins</span> {1}",
    donationCoins = "<span class=\"symbol\">IceCoins</span> {1}",
    given = "Ai dat ~r~{1} ~w~(de) €.",
    received = "~w~Ai primit ~b~{1} ~w~(de) €.",
    not_enough = "~w~Nu ai destule Ice coins",
    paid = "~w~Ai platit ~r~{1} ~w~(de) €.",
    give = {
      title = "Ofera Coins",
  ...
  donationCoins = {
    ...
    onlinePlayers = "<span class=\"symbol\">Online:</span> {1}",
    GiftPoints = "<span class=\"symbol\">IceCoins</span> {1}",
    donationCoins = "<span class=\"symbol\">Ice Coins</span> {1}",
    given = "Ai dat ~r~{1} ~w~(de) €.",
    received = "~w~Ai primit ~b~{1} ~w~(de) €.",
    not_enough = "~w~Nu ai destule Ice Coins",
    paid = "~w~Ai platit ~r~{1} ~w~(de) €.",
  ...
  inventory = {
    ...
    missing = "~w~Lipsesc {2} {1}.",
    full = "~w~Inventar plin.",
    chest = {
      title = "Cufar",
  ...
  business = {
    ...
    launder = {
      ...
      laundered = "~b~{1} (de) euro ~s~spalati.",
  ...
  itemtr = {
    informer = {
      ...
      bought = "~w~Pozitie marcata pe GPS"
    }
  },
  mission = {
    blip = "Misiunea ({1}) {2}/{3}",
