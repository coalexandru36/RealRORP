  ...
  if user_id ~= nil then
    if(vRP.isUserInFaction(user_id,"Smurd") and vRP.hasGroup(user_id,"onduty"))then
      if vRP.tryGetInventoryItem(user_id,"pills",1) then
        ...
        vRPclient.notify(player,{"Folosind pilule."})
        play_drink(player)
...
anti_drog["Injecteaza"] = {function(player,choice)
	...
	if user_id ~= nil then
      ...
      vRPclient.notify(player,{"Ti-ai administrat un anti-drog."})
      vRPclient.notify(player,{"Efectele de la droguri par a fi disparute."})
      Wait(2000)
...
green_choices["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"speish",1) then
      ...
      vRPclient.notify(player,{"Auleo capusele mi-au intrat sub piele."})
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
      vRP.closeMenu(player)
		end
	end
end}
...
green_choices2["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"mushroom",1) then
      ...
      vRPclient.notify(player,{"Auleo ciupercile astea mi-au intrat rau."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices3["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"dmt",1) then
      ...
      vRPclient.notify(player,{"Auleo DMT-ul mi-au intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices4["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"thc",1) then
      ...
      vRPclient.notify(player,{"Auleo THC-ul mi-a intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices5["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"subutex",1) then
      ...
      vRPclient.notify(player,{"Auleo Subutex-u mi-a intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices6["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"amphetamine",1) then
      ...
      vRPclient.notify(player,{"Auleo Amphetamina mi-a intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices7["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"pcp",1) then
      ...
      vRPclient.notify(player,{"Auleo PCP-ul mi-a intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
green_choices8["Foloseste"] = {function(player,choice)
    ...
    if vRP.tryGetInventoryItem(user_id,"heroine",1) then
      ...
      vRPclient.notify(player,{"Auleo Heroina mi-a intrat sub piele."})
      vRP.closeMenu(player)
      Wait(3000)
      vRPclient.notify(player,{"Daca vreau sa dispara efectele astea\ntrebuie sa cumpar un ~y~Anti-Drog ~g~de la ~r~Farmacie~g~."})
		end
...
smell_choices["Foloseste"] = {function(player,choice)
  ...
  if user_id ~= nil then
    if vRP.tryGetInventoryItem(user_id,"cocaine",1) then
      ...
      vRPclient.notify(player,{" smell cocaine."})
      play_smell(player)
      vRP.closeMenu(player)
    end
  end
...
preservative_choices["Foloseste"] = {function(player,choice)
  ...
  if user_id ~= nil then
    if vRP.tryGetInventoryItem(user_id,"preservative",1) then
      ...
      vRPclient.notify(player,{" Ti-ai aplicat un Prezervativ pe Penis-ul tau Mic."})
      vRPclient.notify(player,{" Felicitari acum nu o sa mai faci Copii tura asta :)."})
      vRP.closeMenu(player)
    end
  end
end}
...
lsd_choices["Foloseste"] = {function(player,choice)
  ...
  if user_id ~= nil then
    if vRP.tryGetInventoryItem(user_id,"lsd",1) then
	  vRP.varyThirst(user_id,(20))
      vRPclient.notify(player,{" Taking lsd."})
      play_lsd(player)
      vRP.closeMenu(player)
    end
  end
...
items["kokain"] = {"Cocaina", "Cateva grame de cocaina", nil, 0.5,"pocket"}
items["hash"] = {"Xanax", "Xanax", nil, 0.5,"pocket"}
items["blomster"] = {"LSD", "LSD", nil, 0.5,"pocket"}
items["Imbruvica"] = {"Imbruvica", "Imbruvica", nil, 0.5,"pocket"}
items["coca"] = {"Cocaina", "Cateva grame de cocaina", nil, 0.5,"pocket"}
items["erva"] = {"Iarba", "Iarba", nil, 0.5,"pocket"}
