															...
															vRP.request(target2,""..vRP.getPlayerName(player).." vrea sa vanda casa: " ..address.home.. " Pret: $"..amount.."", 10, function(target,ok)
																if ok then
																	...
																	if (tonumber(money) >= tonumber(amount)) then
																		...
																		vRPclient.notify(player,{"Ai vandut cu succes casa lui ".. vRP.getPlayerName(target).." pentru $"..amount.."!"})
																		vRPclient.notify(target,{""..vRP.getPlayerName(player).." ti-a vandut cu succes casa pentru $"..amount.."!"})
																		vRP.closeMenu(player)
																	else
